  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleRegister} className="space-y-4 text-left">
        ...
        <button
          type="submit"
          className="w-full bg-gradient-to-r from-blue-600 via-blue-500 to-blue-700 hover:from-blue-500 hover:to-blue-600 text-white text-xs py-3.5 px-4 rounded-xl font-bold tracking-wide transition-all shadow-lg shadow-blue-500/20 active:scale-97 cursor-pointer flex items-center justify-center gap-1.5"
        >
          {t.submitButton}
        </button>
      </form>
